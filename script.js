const foodOriginalData = [
  ...
  function getHighestProtiensToLowestData(){
    for( let i=0; i<foodOriginalData.length; i++){
        const protiens = [foodOriginalData[i].protiens]
        protiens.sort(function(a,b){return b.protiens -a.protiens});
        console.log(foodOriginalData[i]);
    }
  }

  function getLowestCabToHighestData(){
    for( let i=0; i<foodOriginalData.length; i++){
        const cab = [foodOriginalData[i].cab]
        cab.sort(function(a,b){return a.cab -b.cab});
        console.log(foodOriginalData[i]);
    }
  }